...
def unit():
    ...
    dm_mod.create_device = lambda device_def, i2c_bus_factory=None, onewire_bus_factory=None, adc_bus_factory=None: driver
...
def test_late_retry_construction_failure_keeps_attempt_count(unit):
    ...
    def _failing_create(device_def, i2c_bus_factory=None, onewire_bus_factory=None, adc_bus_factory=None):
