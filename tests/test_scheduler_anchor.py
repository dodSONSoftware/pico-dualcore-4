...
def _run_core1(fake_time, bus, core1_config, boot_ticks_ms, pre_run=None):
    ...
    try:
        ...
        dm_mod.create_device = lambda device_def, i2c_bus_factory=None, onewire_bus_factory=None, adc_bus_factory=None: ProbeDriver()
...
def _slow_periodic_read(fake_time, delay_ms):
    ...
    def _pre_run():
        ...
        dm_mod.create_device = lambda device_def, i2c_bus_factory=None, onewire_bus_factory=None, adc_bus_factory=None: _SlowDriver()
